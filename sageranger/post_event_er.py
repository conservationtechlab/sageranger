...
def post_event(label, cam_name, authorization):
    ...
    Args:
        cam_name (str): a string of the specific name of the camera that the image came
            from as it also is in Earthranger
        authorization (str): the auth token for ER as defined in config
        label (str): the name of the animal identified to be sent, used as title of jpeg
